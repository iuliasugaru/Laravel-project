...
<p style="margin-right:5px">Total: $ {{ $total }}</p>
...
<img src="{{ $details['image'] }}" alt="loading" height="180px">
</div>

<div style="margin-right=1px; padding=0; text-align=right; color:#714f4b;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       {{ $details['name'] }}
<br>
